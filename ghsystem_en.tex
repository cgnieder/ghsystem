...
\begin{options}
  \keyval{language}{lang}\Default{english}
    Selects\changedversion{5.0} a language and if called in the preamble also
    ...
    \code{english}.  Currently available choices are English, German, Italian,
    and Spanish.  \meta{lang} can be a comma separated list.  Then the last
